unit NEOWatch.WebApp.Presentation.View.Monitoring.Sempare;
...
constructor TViewMonitoringSempare.Create(const Logger: ILogger);
begin
  inherited Create;
  FLogger := Utilities.CheckNotNullAndSet(Logger, 'Logger');
end;

procedure TViewMonitoringSempare.HandleTemplateError(const AMessage: string);
begin
