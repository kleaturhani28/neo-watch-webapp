unit NEOWatch.WebApp.Presentation.Model.DTO.WSAsteroidDetails;
...
type
  ...
  private
    ...
    FCloseApproaches: TObjectList<TWSCloseApproachDTO>;
    ...
    function GetCloseApproaches: TObjectList<TWSCloseApproachDTO>;
    ...
    procedure SetCloseApproaches(const Value: TObjectList<TWSCloseApproachDTO>);
  ...
  published
    ...
    property CloseApproaches: TObjectList<TWSCloseApproachDTO> read GetCloseApproaches write SetCloseApproaches;
...
{ TWSAsteroidDetailDTO }

constructor TWSAsteroidDetailDTO.Create;
begin
  inherited;
  FCloseApproaches := TObjectList<TWSCloseApproachDTO>.Create;
end;

destructor TWSAsteroidDetailDTO.Destroy;
begin
  FCloseApproaches.Free;
  inherited;
end;

function TWSAsteroidDetailDTO.GetAbsoluteMagnitude: Extended;
begin
  Result := FAbsoluteMagnitude;
end;

function TWSAsteroidDetailDTO.GetAbsoluteMagnitudeText: string;
begin
  Result := FAbsoluteMagnitudeText;
end;

function TWSAsteroidDetailDTO.GetAsteroidCardCssClass: string;
begin
  Result := FAsteroidCardCssClass;
end;

function TWSAsteroidDetailDTO.GetCloseApproachDate: TDateTime;
begin
  Result := FCloseApproachDate;
end;

function TWSAsteroidDetailDTO.GetCloseApproachDateText: string;
begin
  Result := FCloseApproachDateText;
end;

function TWSAsteroidDetailDTO.GetCloseApproaches: TObjectList<TWSCloseApproachDTO>;
begin
  Result := FCloseApproaches;
end;

function TWSAsteroidDetailDTO.GetDataArcInDaysText: string;
begin
  Result := FDataArcInDaysText;
end;

function TWSAsteroidDetailDTO.GetDiameterText: string;
begin
  Result := FDiameterText;
end;

function TWSAsteroidDetailDTO.GetEstimatedDiameterMaxMeters: Extended;
begin
  Result := FEstimatedDiameterMaxMeters;
end;

function TWSAsteroidDetailDTO.GetEstimatedDiameterMinMeters: Extended;
begin
  Result := FEstimatedDiameterMinMeters;
end;

function TWSAsteroidDetailDTO.GetFirstObservationDateText: string;
begin
  Result := FFirstObservationDateText;
end;

function TWSAsteroidDetailDTO.GetHasCloseApproaches: Boolean;
begin
  Result := FHasCloseApproaches;
end;

function TWSAsteroidDetailDTO.GetHasOrbitalData: Boolean;
begin
  Result := FHasOrbitalData;
end;

function TWSAsteroidDetailDTO.GetHazardousCssClass: string;
begin
  Result := FHazardousCssClass;
end;

function TWSAsteroidDetailDTO.GetHazardousLabel: string;
begin
  Result := FHazardousLabel;
end;

function TWSAsteroidDetailDTO.GetId: string;
begin
  Result := FId;
end;

function TWSAsteroidDetailDTO.GetIsPotentiallyHazardous: Boolean;
begin
  Result := FIsPotentiallyHazardous;
end;

function TWSAsteroidDetailDTO.GetLastObservationDateText: string;
begin
  Result := FLastObservationDateText;
end;

function TWSAsteroidDetailDTO.GetMinDistanceKm: Extended;
begin
  Result := FMinDistanceKm;
end;

function TWSAsteroidDetailDTO.GetMinDistanceKmText: string;
begin
  Result := FMinDistanceKmText;
end;

function TWSAsteroidDetailDTO.GetName: string;
begin
  Result := FName;
end;

function TWSAsteroidDetailDTO.GetNasaJplUrl: string;
begin
  Result := FNasaJplUrl;
end;

function TWSAsteroidDetailDTO.GetObservationsUsedText: string;
begin
  Result := FObservationsUsedText;
end;

function TWSAsteroidDetailDTO.GetOrbitClassText: string;
begin
  Result := FOrbitClassText;
end;

function TWSAsteroidDetailDTO.GetOrbitDeterminationDateText: string;
begin
  Result := FOrbitDeterminationDateText;
end;

function TWSAsteroidDetailDTO.GetOrbitId: string;
begin
  Result := FOrbitId;
end;

function TWSAsteroidDetailDTO.GetRelativeVelocityKmH: Extended;
begin
  Result := FRelativeVelocityKmH;
end;

function TWSAsteroidDetailDTO.GetRelativeVelocityText: string;
begin
  Result := FRelativeVelocityText;
end;

procedure TWSAsteroidDetailDTO.SetAbsoluteMagnitude(const Value: Extended);
begin
  FAbsoluteMagnitude := Value;
end;

procedure TWSAsteroidDetailDTO.SetAbsoluteMagnitudeText(const Value: string);
begin
  FAbsoluteMagnitudeText := Value;
end;

procedure TWSAsteroidDetailDTO.SetAsteroidCardCssClass(const Value: string);
begin
  FAsteroidCardCssClass := Value;
end;

procedure TWSAsteroidDetailDTO.SetCloseApproachDate(const Value: TDateTime);
begin
  FCloseApproachDate := Value;
end;

procedure TWSAsteroidDetailDTO.SetCloseApproachDateText(const Value: string);
begin
  FCloseApproachDateText := Value;
end;

procedure TWSAsteroidDetailDTO.SetCloseApproaches(const Value: TObjectList<TWSCloseApproachDTO>);
begin
...
procedure TWSAsteroidDetailDTO.SetDataArcInDaysText(const Value: string);
begin
  FDataArcInDaysText := Value;
end;

procedure TWSAsteroidDetailDTO.SetDiameterText(const Value: string);
begin
  FDiameterText := Value;
end;

procedure TWSAsteroidDetailDTO.SetEstimatedDiameterMaxMeters(const Value: Extended);
begin
  FEstimatedDiameterMaxMeters := Value;
end;

procedure TWSAsteroidDetailDTO.SetEstimatedDiameterMinMeters(const Value: Extended);
begin
  FEstimatedDiameterMinMeters := Value;
end;

procedure TWSAsteroidDetailDTO.SetFirstObservationDateText(const Value: string);
begin
  FFirstObservationDateText := Value;
end;

procedure TWSAsteroidDetailDTO.SetHasCloseApproaches(const Value: Boolean);
begin
  FHasCloseApproaches := Value;
end;

procedure TWSAsteroidDetailDTO.SetHasOrbitalData(const Value: Boolean);
begin
  FHasOrbitalData := Value;
end;

procedure TWSAsteroidDetailDTO.SetHazardousCssClass(const Value: string);
begin
  FHazardousCssClass := Value;
end;

procedure TWSAsteroidDetailDTO.SetHazardousLabel(const Value: string);
begin
  FHazardousLabel := Value;
end;

procedure TWSAsteroidDetailDTO.SetId(const Value: string);
begin
  FId := Value;
end;

procedure TWSAsteroidDetailDTO.SetIsPotentiallyHazardous(const Value: Boolean);
begin
  FIsPotentiallyHazardous := Value;
end;

procedure TWSAsteroidDetailDTO.SetLastObservationDateText(const Value: string);
begin
  FLastObservationDateText := Value;
end;

procedure TWSAsteroidDetailDTO.SetMinDistanceKm(const Value: Extended);
begin
  FMinDistanceKm := Value;
end;

procedure TWSAsteroidDetailDTO.SetMinDistanceKmText(const Value: string);
begin
  FMinDistanceKmText := Value;
end;

procedure TWSAsteroidDetailDTO.SetName(const Value: string);
begin
  FName := Value;
end;

procedure TWSAsteroidDetailDTO.SetNasaJplUrl(const Value: string);
begin
  FNasaJplUrl := Value;
end;

procedure TWSAsteroidDetailDTO.SetObservationsUsedText(const Value: string);
begin
  FObservationsUsedText := Value;
end;

procedure TWSAsteroidDetailDTO.SetOrbitClassText(const Value: string);
begin
  FOrbitClassText := Value;
end;

procedure TWSAsteroidDetailDTO.SetOrbitDeterminationDateText(const Value: string);
begin
  FOrbitDeterminationDateText := Value;
end;

procedure TWSAsteroidDetailDTO.SetOrbitId(const Value: string);
begin
  FOrbitId := Value;
end;

procedure TWSAsteroidDetailDTO.SetRelativeVelocityKmH(const Value: Extended);
begin
  FRelativeVelocityKmH := Value;
end;

procedure TWSAsteroidDetailDTO.SetRelativeVelocityText(const Value: string);
begin
