unit NEOWatch.WebApp.Presentation.Model.DTO.WSCloseApproach;

interface

type
  TWSCloseApproachDTO = class
  private
...
function TWSCloseApproachDTO.GetCloseApproachDate: TDateTime;
begin
  Result := FCloseApproachDate;
end;

function TWSCloseApproachDTO.GetCloseApproachDateText: string;
begin
  Result := FCloseApproachDateText;
end;

function TWSCloseApproachDTO.GetMissDistanceKm: Extended;
begin
  Result := FMissDistanceKm;
end;

function TWSCloseApproachDTO.GetMissDistanceKmText: string;
begin
  Result := FMissDistanceKmText;
end;

function TWSCloseApproachDTO.GetOrbitingBody: string;
begin
  Result := FOrbitingBody;
end;

function TWSCloseApproachDTO.GetRelativeVelocityKmH: Extended;
begin
  Result := FRelativeVelocityKmH;
end;

function TWSCloseApproachDTO.GetRelativeVelocityText: string;
begin
  Result := FRelativeVelocityText;
end;

procedure TWSCloseApproachDTO.SetCloseApproachDate(const Value: TDateTime);
begin
  FCloseApproachDate := Value;
end;

procedure TWSCloseApproachDTO.SetCloseApproachDateText(const Value: string);
begin
  FCloseApproachDateText := Value;
end;

procedure TWSCloseApproachDTO.SetMissDistanceKm(const Value: Extended);
begin
  FMissDistanceKm := Value;
end;

procedure TWSCloseApproachDTO.SetMissDistanceKmText(const Value: string);
begin
  FMissDistanceKmText := Value;
end;

procedure TWSCloseApproachDTO.SetOrbitingBody(const Value: string);
begin
  FOrbitingBody := Value;
end;

procedure TWSCloseApproachDTO.SetRelativeVelocityKmH(const Value: Extended);
begin
  FRelativeVelocityKmH := Value;
end;

procedure TWSCloseApproachDTO.SetRelativeVelocityText(const Value: string);
begin
