unit NEOWatch.WebApp.Presentation.Model.DTO.WSAsteroidCard;

interface

type
  TWSAsteroidCardDTO = class
  private
    FId: string;
    FName: string;
...
function TWSAsteroidCardDTO.GetAsteroidCardCssClass: string;
begin
  Result := FAsteroidCardCssClass;
end;

function TWSAsteroidCardDTO.GetCloseApproachDate: TDateTime;
begin
  Result := FCloseApproachDate;
end;

function TWSAsteroidCardDTO.GetCloseApproachDateText: string;
begin
  Result := FCloseApproachDateText;
end;

function TWSAsteroidCardDTO.GetDiameterText: string;
begin
  Result := FDiameterText;
end;

function TWSAsteroidCardDTO.GetEstimatedDiameterMaxMeters: Extended;
begin
  Result := FEstimatedDiameterMaxMeters;
end;

function TWSAsteroidCardDTO.GetEstimatedDiameterMinMeters: Extended;
begin
  Result := FEstimatedDiameterMinMeters;
end;

function TWSAsteroidCardDTO.GetHazardousCssClass: string;
begin
  Result := FHazardousCssClass;
end;

function TWSAsteroidCardDTO.GetHazardousLabel: string;
begin
  Result := FHazardousLabel;
end;

function TWSAsteroidCardDTO.GetId: string;
begin
  Result := FId;
end;

function TWSAsteroidCardDTO.GetIsPotentiallyHazardous: Boolean;
begin
  Result := FIsPotentiallyHazardous;
end;

function TWSAsteroidCardDTO.GetMinDistanceKm: Extended;
begin
  Result := FMinDistanceKm;
end;

function TWSAsteroidCardDTO.GetMinDistanceKmText: string;
begin
  Result := FMinDistanceKmText;
end;

function TWSAsteroidCardDTO.GetName: string;
begin
  Result := FName;
end;

function TWSAsteroidCardDTO.GetNasaJplUrl: string;
begin
  Result := FNasaJplUrl;
end;

function TWSAsteroidCardDTO.GetRelativeVelocityKmH: Extended;
begin
  Result := FRelativeVelocityKmH;
end;

function TWSAsteroidCardDTO.GetRelativeVelocityText: string;
begin
  Result := FRelativeVelocityText;
end;

procedure TWSAsteroidCardDTO.SetAsteroidCardCssClass(const Value: string);
begin
  FAsteroidCardCssClass := Value;
end;

procedure TWSAsteroidCardDTO.SetCloseApproachDate(const Value: TDateTime);
begin
  FCloseApproachDate := Value;
end;

procedure TWSAsteroidCardDTO.SetCloseApproachDateText(const Value: string);
begin
  FCloseApproachDateText := Value;
end;

procedure TWSAsteroidCardDTO.SetDiameterText(const Value: string);
begin
  FDiameterText := Value;
end;

procedure TWSAsteroidCardDTO.SetEstimatedDiameterMaxMeters(const Value: Extended);
begin
  FEstimatedDiameterMaxMeters := Value;
end;

procedure TWSAsteroidCardDTO.SetEstimatedDiameterMinMeters(const Value: Extended);
begin
  FEstimatedDiameterMinMeters := Value;
end;

procedure TWSAsteroidCardDTO.SetHazardousCssClass(const Value: string);
begin
  FHazardousCssClass := Value;
end;

procedure TWSAsteroidCardDTO.SetHazardousLabel(const Value: string);
begin
  FHazardousLabel := Value;
end;

procedure TWSAsteroidCardDTO.SetId(const Value: string);
begin
  FId := Value;
end;

procedure TWSAsteroidCardDTO.SetIsPotentiallyHazardous(const Value: Boolean);
begin
  FIsPotentiallyHazardous := Value;
end;

procedure TWSAsteroidCardDTO.SetMinDistanceKm(const Value: Extended);
begin
  FMinDistanceKm := Value;
end;

procedure TWSAsteroidCardDTO.SetMinDistanceKmText(const Value: string);
begin
  FMinDistanceKmText := Value;
end;

procedure TWSAsteroidCardDTO.SetName(const Value: string);
begin
  FName := Value;
end;

procedure TWSAsteroidCardDTO.SetNasaJplUrl(const Value: string);
begin
  FNasaJplUrl := Value;
end;

procedure TWSAsteroidCardDTO.SetRelativeVelocityKmH(const Value: Extended);
begin
  FRelativeVelocityKmH := Value;
end;

procedure TWSAsteroidCardDTO.SetRelativeVelocityText(const Value: string);
begin
