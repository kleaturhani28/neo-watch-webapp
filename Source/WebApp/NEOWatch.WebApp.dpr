...
uses
  ...
  NEOWatch.WebApp.Presentation.Controller.Main
      in 'Presentation\Controllers\NEOWatch.WebApp.Presentation.Controller.Main.pas',
  NEOWatch.WebApp.Presentation.Controller.Asteroids
      in 'Presentation\Controllers\NEOWatch.WebApp.Presentation.Controller.Asteroids.pas',
  NEOWatch.WebApp.Presentation.Model.DTO.WSMonitoring
      in 'Presentation\Models\DTOs\NEOWatch.WebApp.Presentation.Model.DTO.WSMonitoring.pas',
  NEOWatch.WebApp.Presentation.Model.DTO.WSAsteroidFilters
      in 'Presentation\Models\DTOs\NEOWatch.WebApp.Presentation.Model.DTO.WSAsteroidFilters.pas',
  ...
  NEOWatch.WebApp.Presentation.Model.DTO.WSAsteroidSummary
      in 'Presentation\Models\DTOs\NEOWatch.WebApp.Presentation.Model.DTO.WSAsteroidSummary.pas',
  NEOWatch.WebApp.Presentation.Model.DTO.WSAsteroidCard
      in 'Presentation\Models\DTOs\NEOWatch.WebApp.Presentation.Model.DTO.WSAsteroidCard.pas',
  NEOWatch.WebApp.Presentation.Model.DTO.WSAsteroidDetails
      in 'Presentation\Models\DTOs\NEOWatch.WebApp.Presentation.Model.DTO.WSAsteroidDetails.pas',
  NEOWatch.WebApp.Presentation.Model.DTO.WSCloseApproach
      in 'Presentation\Models\DTOs\NEOWatch.WebApp.Presentation.Model.DTO.WSCloseApproach.pas',
  ...
  NEOWatch.WebApp.Presentation.View.Main.Sempare
      in 'Presentation\Views\NEOWatch.WebApp.Presentation.View.Main.Sempare.pas',
  NEOWatch.WebApp.Presentation.View.AsteroidDetail.Intf
      in 'Presentation\Views\NEOWatch.WebApp.Presentation.View.AsteroidDetail.Intf.pas',
  NEOWatch.WebApp.Presentation.View.AsteroidDetail.Sempare
      in 'Presentation\Views\NEOWatch.WebApp.Presentation.View.AsteroidDetail.Sempare.pas',
  NEOWatch.WebApp.Presentation.View.Monitoring.Intf
      in 'Presentation\Views\NEOWatch.WebApp.Presentation.View.Monitoring.Intf.pas',
  NEOWatch.WebApp.Presentation.View.Monitoring.Sempare
      in 'Presentation\Views\NEOWatch.WebApp.Presentation.View.Monitoring.Sempare.pas',
  NEOWatch.WebApp.Registrations in 'NEOWatch.WebApp.Registrations.pas',
  NEOWatch.WebApp.Presentation.Model.Monitoring.Intf
      in 'Presentation\Models\NEOWatch.WebApp.Presentation.Model.Monitoring.Intf.pas',
  NEOWatch.WebApp.Presentation.Model.Monitoring
      in 'Presentation\Models\NEOWatch.WebApp.Presentation.Model.Monitoring.pas',
  NEOWatch.WebApp.Domain.Entity.AsteroidFilters.Intf
      in 'Domain\Entities\NEOWatch.WebApp.Domain.Entity.AsteroidFilters.Intf.pas',
  ...
  NEOWatch.WebApp.Presentation.Service.DTO.Authorizations
      in 'Presentation\Services\DTOs\NEOWatch.WebApp.Presentation.Service.DTO.Authorizations.pas',
  NEOWatch.WebApp.Presentation.Service.DTO.Environment
      in 'Presentation\Services\DTOs\NEOWatch.WebApp.Presentation.Service.DTO.Environment.pas',
  NEOWatch.WebApp.Presentation.Service.DTO.SessionInfo
      in 'Presentation\Services\DTOs\NEOWatch.WebApp.Presentation.Service.DTO.SessionInfo.pas',
  NEOWatch.WebApp.Presentation.Service.Session.Utils
      in 'Presentation\Services\NEOWatch.WebApp.Presentation.Service.Session.Utils.pas',
  NEOWatch.WebApp.CommandLine in 'NEOWatch.WebApp.CommandLine.pas',
  NEOWatch.WebApp.Presentation.Service.Session.Intf
      in 'Presentation\Services\NEOWatch.WebApp.Presentation.Service.Session.Intf.pas',
  NEOWatch.WebApp.Presentation.Service.Session
      in 'Presentation\Services\NEOWatch.WebApp.Presentation.Service.Session.pas',
  ...
  NEOWatch.WebApp.Persistence.Repository.Session
      in 'Persistence\Repositories\NEOWatch.WebApp.Persistence.Repository.Session.pas',
  NEOWatch.WebApp.Constants in 'NEOWatch.WebApp.Constants.pas',
  NEOWatch.WebApp.Persistence.Repository.Monitoring
      in 'Persistence\Repositories\NEOWatch.WebApp.Persistence.Repository.Monitoring.pas',
  NEOWatch.WebApp.Presentation.Controller.Monitoring
      in 'Presentation\Controllers\NEOWatch.WebApp.Presentation.Controller.Monitoring.pas';
...
{$ENDIF}
  try
    ...
    Container.Resolve<IMonitoringController>.RegisterRoutes;
